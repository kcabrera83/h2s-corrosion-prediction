...
def test_models():
    results = {}
    results['corrosion_rate'] = evaluate_model(os.path.join(MODEL_DIR, 'corrosion_rate_model.pkl'), X, y)
    results['remaining_life'] = evaluate_model(os.path.join(MODEL_DIR, 'remaining_life_model.pkl'), X, y)
    return results
